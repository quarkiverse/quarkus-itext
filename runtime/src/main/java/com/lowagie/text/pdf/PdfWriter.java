...
public class PdfWriter extends DocWriter implements
    ...
    static class PdfTrailer extends PdfDictionary {
        ...
        PdfTrailer(int size, int offset, PdfIndirectReference root, PdfIndirectReference info, PdfIndirectReference encryption,
     ...
     * @throws IOException on error
     */
    public void setOutputIntents(String outputConditionIdentifier, String outputCondition, String registryName, String info,
     ...
     * @deprecated As of iText 2.0.3, replaced by (@link #setEncryption(byte[], byte[], int, int)}. Scheduled for removal at or
     *             after 2.2.0
     */
    ...
    protected HashMap documentExtGState = new LinkedHashMap();
