                ...
                try {
                    ...
                    if (symbolic) {
                        ...
                        for (int k = 0; k < len; ++k) {
                            ...
                            if (metrics == null)
                                continue;
                            longTag.put(Integer.valueOf(metrics[0]),
    ...
    byte[] convertToBytes(GlyphVector glyphVector) {
        ...
        for (int i = 0; i < glyphs.length; i++) {
            ...
            if (!longTag.containsKey(codeKey)) {
                ...
                int[] metrics = charCode != null ? new int[] { code, glyphWidth, charCode.intValue() }
                        : new int[] {
                                code, glyphWidth };
        ...
        try {
            switch (fontType) {
                ...
                case BaseFont.FONT_TYPE_TT: {
                    ...
                    baseFont.writeFont(writer, indirectReference, new Object[] { Integer.valueOf(firstChar),
                            Integer.valueOf(lastChar), shortTag, Boolean.valueOf(subset) });
                    break;
                }
                case BaseFont.FONT_TYPE_CJK:
