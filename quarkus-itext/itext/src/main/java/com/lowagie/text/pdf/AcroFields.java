...
public class AcroFields {
                    ...
                    if (hit.isHit(k)) {
                        ...
                        if (da != null && dr != null) {
                            ...
                            if (dao[DA_FONT] != null) {
                                ...
                                buf.append(psn.getBytes()).append(' ').append(((Float) dao[DA_SIZE]).floatValue())
                                        .append(" Tf ");
                        ...
                        if (da != null) {
                            ...
                            if (dao[DA_FONT] != null) {
                                ...
                                buf.append(new PdfName((String) dao[DA_FONT]).getBytes()).append(' ')
                                        .append(((Float) dao[DA_SIZE]).floatValue()).append(" Tf ");
                    ...
                    if (hit.isHit(k)) {
                        ...
                        if (da != null) {
                            ...
                            if (dao[DA_FONT] != null) {
                                ByteBuffer buf = cb.getInternalBuffer();
                                buf.append(new PdfName((String) dao[DA_FONT]).getBytes()).append(' ')
                                        .append(((Float) value).floatValue()).append(" Tf ");
                                if (dao[DA_COLOR] != null)
                                    cb.setColorFill((Color) dao[DA_COLOR]);
                                PdfString s = new PdfString(cb.toString());
                                item.getMerged(k).put(PdfName.DA, s);
    ...
    /**
     * Gets the list of substitution fonts. The list is composed of <CODE>BaseFont</CODE> and can be <CODE>null</CODE>. The
     * fonts in this list will be used if the original
     * font doesn't contain the needed glyphs.
     *
     * @return the list
     */
    ...
    /**
     * Sets a list of substitution fonts. The list is composed of <CODE>BaseFont</CODE> and can also be <CODE>null</CODE>. The
     * fonts in this list will be used if the original
     * font doesn't contain the needed glyphs.
     *
