...
public class PushbuttonField extends BaseField {
     ...
     *
     * @param iconVerticalAdjustment a number between 0 and 1 indicating the fraction of leftover space to allocate at the
     *        bottom of the icon
     */
     ...
     * A value of 0.5 centers it within the rectangle. The default is 0.5.
     *
     * @param iconHorizontalAdjustment a number between 0 and 1 indicating the fraction of leftover space to allocate at the
     *        left of the icon
     */
        ...
        while (true) {
            switch (nlayout) {
                ...
                case LAYOUT_LABEL_LEFT_ICON_RIGHT:
                    ...
                    textX = offX + 1;
                    textY = (box.getHeight() - ufont.getFontDescriptor(BaseFont.ASCENT, fsize)) / 2;
                    iconBox = new Rectangle(textX + ufont.getWidthPoint(text, fsize), box.getBottom() + adj,
