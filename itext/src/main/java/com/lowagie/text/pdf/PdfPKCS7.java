...
public class PdfPKCS7 {
    ...
    public PdfPKCS7(byte[] contentsKey, String provider) {
        try {
            ...
            digestEncryptionAlgorithm = ((ASN1ObjectIdentifier) ((ASN1Sequence) signerInfo.getObjectAt(next++)).getObjectAt(0))
                    .getId();
            ...
            for (int i = 0; i < AccessDescriptions.size(); i++) {
                ...
                if (AccessDescription.size() != 2) {
                    ...
                    if ((AccessDescription.getObjectAt(0) instanceof ASN1ObjectIdentifier)
                            && ((ASN1ObjectIdentifier) AccessDescription.getObjectAt(0)).getId().equals("1.3.6.1.5.5.7.48.1")) {
        ...
        if (digestEncryptionAlgorithm != null) {
            if (digestEncryptionAlgorithm.equals("RSA")) {
                ...
                throw new ExceptionConverter(
                        new NoSuchAlgorithmException("Unknown Key Algorithm " + digestEncryptionAlgorithm));
        }
    }
