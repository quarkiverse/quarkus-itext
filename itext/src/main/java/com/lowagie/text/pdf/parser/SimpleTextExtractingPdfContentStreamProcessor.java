...
public class SimpleTextExtractingPdfContentStreamProcessor extends PdfContentStreamProcessor {
     ...
     * @see com.lowagie.text.pdf.parser.PdfContentStreamProcessor#displayText(java.lang.String,
    ...
    public void displayText(String text, Matrix endingTextMatrix) {
        ...
        if (hardReturn) {
            ...
            float spaceWidth = (spaceGlyphWidth * gs().fontSize + gs().characterSpacing + gs().wordSpacing)
                    * gs().horizontalScaling; // this is unscaled!!
